...
--
-- Σύστημα: localhost
-- Χρόνος δημιουργίας: 22 Μαΐου 2013 στις 16:00:57
...
CREATE TABLE IF NOT EXISTS `queue` (
  ...
  KEY `expire` (`expire`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores items in queues.' AUTO_INCREMENT=45 ;
...
(1, 'BV72et8F5zxY14oDz0e1qtGN3HfuWvBUBLX5veefuSo', '', '127.0.0.1', 1369231119, 0, 0x626174636865737c613a313a7b693a313b623a313b7d64626c6f675f6f766572766965775f66696c7465727c613a303a7b7d);
...
(1, 'admin', '$S$DhKvf89EiEQihfj9kzfzbOtg2nxJ.tTVk2.P4R9oTEBvtt0BPKnj', 'gtsopour@gmail.com', '', '', 'filtered_html', 1369136851, 1369231119, 1369137870, 1, 'Europe/Helsinki', '', 0, 'gtsopour@gmail.com', 0x613a323a7b733a373a22636f6e74616374223b693a303b733a373a226f7665726c6179223b693a313b7d);
